...
describe('what it promises is what the database does', () => {
  test('every retention period on the page is one the database enforces', () => {
    ...
    const expected = [
      ...
      ['The dates you used the app', '24 months'],
      ['A connection to an outside training app', '12 months'],
    ...
    const disclosed = {
      ...
      activity_days: 'The dates you used the app',
      hevy_connections: 'A connection to an outside training app',
