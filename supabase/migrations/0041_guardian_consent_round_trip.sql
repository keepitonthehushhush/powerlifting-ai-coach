-- =============================================================================
-- 0041_guardian_consent_round_trip.sql
--
...
comment on table public.guardian_consent_requests is
  'Outstanding and answered guardian consent links. Holds the SHA-256 of the token, never the token. Written only by the security-definer functions below: the athlete may read their own row to see whether a guardian has answered, and may read no token hash. See migration 0041.';
