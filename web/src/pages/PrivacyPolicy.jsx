    ...
    <div className="page">
      ...
      <div className="card prose">
        ...
        <ul>
          ...
          <li>
            <strong>Guardian consent requests: 24 months</strong> from when the request was
            made. This is the errand — who was asked, when, and what they answered — and it
            holds an address belonging to somebody who never signed up here. The consent
            itself stays on the permanent record, because that is the thing we may have to
            show; the way we reached your guardian does not need to outlive it.
          </li>
        </ul>
        <p>
