...
export const es = {
  common: {
     ...
     */
    coachTableLabel: 'Una tabla de tu entrenador',
  ...
  program: {
    ...
    changes: {
      heading: 'Qué cambió desde tu programa anterior',
      since: 'Comparado con la semana {week}, escrito el {date}.',
      identical: 'No cambió nada. Mismos ejercicios, mismas cargas, mismas series y repeticiones.',
      phase: 'Fase: {from} → {to}',
      days: 'Días de entrenamiento: {from} → {to} por semana',
      load: '{from} → {to} {units} ({delta})',
      loadNoUnits: '{from} → {to} ({delta})',
      setsReps: '{from} → {to}',
      timesPerWeek: '{from}× → {to}× por semana',
      added: 'Se agregó',
      removed: 'Se quitó',
      heaviestNote: 'Se prescribe con más de una carga; la comparación usa la más pesada.',
      why: {
        increase: 'Completaste todas las repeticiones con la carga anterior, así que subió el peso.',
        deload: 'Tres sesiones sin completar las repeticiones, así que el peso bajó y los saltos se hicieron más chicos.',
        hold: 'El mismo peso otra vez: en el último intento no te quedó una repetición de reserva.',
        start: 'Un peso inicial, según lo que nos dijiste al registrarte.',
        exhausted: 'La progresión lineal en este ejercicio se terminó; ahora necesita otro esquema.',
      },
      coach: 'Lo decidió Coach. Tus series registradas apuntaban a {expected} {units}. Casi siempre hay una razón que el registro no alcanza a ver, así que pregúntale.',
      coachNoUnits: 'Lo decidió Coach. Tus series registradas apuntaban a {expected}. Casi siempre hay una razón que el registro no alcanza a ver, así que pregúntale.',
      coachNoNumber: 'Lo decidió Coach en lugar de seguir tus series registradas. Pregúntale por qué.',
      unknown: 'No hay nada registrado de este ejercicio, así que no se puede decir por qué cambió.',
    },
  ...
  chat: {
    ...
    starters: {
      ...
      clearanceWhatNow: 'Todavía no me han dado el alta. ¿Qué podemos hacer mientras tanto?',
      clearanceAskDoctor: '¿Qué le debo preguntar a mi doctor o fisioterapeuta?',
      clearanceMeanwhile: '¿En qué puedo trabajar sin riesgo que no involucre la lesión?',
    },
    you: 'Tú',
    coach: 'Coach',
    programSaved: 'La semana {week} está guardada: {days} días, lista para seguir.',
    programSavedLink: 'Abrir tu programa',
    bodyweightSaved: 'Tu peso corporal ahora es {weight} en tu perfil.',
    bodyweightSavedLink: 'Cambiarlo',
    logThis: '\u00bfRegistro este entrenamiento? {count} movimiento(s).',
    logYes: 'S\u00ed, reg\u00edstralo',
    logNo: 'Ahora no',
    logSets: '{count} series',
    logRpe: 'RPE {rpe}',
    logMissed: 'no completado',
    logging: 'Guardando\u2026',
    logged: 'Registrado. Est\u00e1 en tu historial.',
    loggedLink: 'Ver tu progreso',
    ...
    thinkingLong: 'Todavía escribiendo. Una semana completa de entrenamiento tarda un rato — el contador de arriba sigue avanzando.',
    sendingUndo: 'Enviando en {seconds}…',
    undo: 'Deshacer',
    undone: 'No se envió. Tu mensaje volvió al cuadro de texto.',
    truncated: 'Esa respuesta se quedó sin espacio.',
    continueCut: 'Pídele que la termine',
    continueDraft: 'Se cortó. Sigue desde donde se quedó.',
  ...
  tracker: {
    heading: 'Conecta tu app de entrenamiento',
    intro:
      'Si ya registras tus entrenamientos en Hevy, conéctalo y el entrenador leerá esos entrenamientos. No hay que anotar nada dos veces: tu programa, tus gráficas y el peso que te sugiere salen de las sesiones que ya estabas registrando.',
    keyLabel: 'Clave API de Hevy',
    whereToFind: 'En la app de Hevy: Ajustes, luego Developer, y ahí generas una clave API. Pega la clave completa.',
    proRequired: 'Hevy exige una suscripción Pro para generar una clave API. Es su regla, no la nuestra.',
    connectButton: 'Conectar Hevy',
    stateReady: 'Conectado. Tus entrenamientos recientes ya están aquí.',
    stateImporting: 'Conectado. Todavía estamos importando tus últimos 90 días: presiona sincronizar otra vez para continuar.',
    lastSynced: 'Última sincronización: {when}.',
    syncButton: 'Sincronizar ahora',
    syncing: 'Sincronizando…',
    runSummary: 'Entraron {imported} entrenamientos nuevos, {duplicates} ya estaban aquí y se eliminaron {deleted}.',
    runMore: 'Falta más por traer: presiona sincronizar otra vez.',
    disconnectButton: 'Desconectar',
    disconnectNote: 'Al desconectar borramos tu clave de nuestra base de datos. Los entrenamientos ya importados se quedan en tu historial.',
    readOnly: 'Solo leemos. Nunca escribimos nada en tu cuenta de Hevy y no cambiamos ninguna de tus rutinas.',
    failure: {
      tracker_key_rejected: 'Hevy ya no acepta esa clave. Genera una nueva en su app y vuelve a conectar.',
      tracker_rate_limited: 'Hevy nos pidió ir más despacio. Inténtalo de nuevo en unos minutos.',
      tracker_unavailable: 'Hevy no respondió la última vez. Inténtalo de nuevo en un momento.',
      unknown: 'La última sincronización no terminó. Inténtalo de nuevo.',
    },
  },
  account: {
    title: 'Tus datos',
  ...
  progress: {
    ...
    hoverHint: 'Pasa el cursor sobre un punto para ver los detalles, o usa las flechas del teclado.',
    tapHint: 'Toca un punto para ver los detalles.',
