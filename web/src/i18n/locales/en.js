...
export const en = {
  ...
  program: {
    ...
    changes: {
      heading: 'What changed since your last program',
      since: 'Compared with week {week}, written {date}.',
      identical: 'Nothing changed. Same lifts, same loads, same sets and reps.',
      phase: 'Phase: {from} → {to}',
      days: 'Training days: {from} → {to} per week',
      load: '{from} → {to} {units} ({delta})',
      loadNoUnits: '{from} → {to} ({delta})',
      setsReps: '{from} → {to}',
      timesPerWeek: '{from}× → {to}× per week',
      added: 'Added',
      removed: 'Removed',
      heaviestNote: 'Prescribed at more than one load; compared on the heaviest.',
      why: {
        increase: 'Every rep completed at the old weight, so the load went up.',
        deload: 'Three sessions short of the prescribed reps, so the weight came back and the steps got smaller.',
        hold: 'Same weight again — the last attempt did not have a rep in hand.',
        start: 'A starting weight, from what you told us at intake.',
        exhausted: 'Linear progression on this lift is finished; it needs a different scheme now.',
      },
      coach: 'Coach chose this. Your logged sets pointed at {expected} {units} — there is usually a reason the log cannot see, so ask.',
      coachNoUnits: 'Coach chose this. Your logged sets pointed at {expected} — there is usually a reason the log cannot see, so ask.',
      coachNoNumber: 'Coach chose this rather than following the logged sets. Ask why.',
      unknown: 'Nothing logged for this lift, so there is no way to say why it moved.',
    },
  ...
  guardian: {
    ...
    why: 'Because you are under 18, Coach Diaz will not start coaching you until a parent or guardian has read what this is and agreed to it.',
    readIt: 'Read what they will see.',
    label: 'Their email address',
    resendLabel: 'Send it to a different address, or send it again',
    placeholder: 'parent@example.com',
    send: 'Send them the link',
    resend: 'Send it again',
    sending: 'Sending…',
    sent: 'Sent. They have a link to read it and decide — nothing changes until they do.',
    awaiting: 'We sent a link to',
    awaitingHint: 'Nothing happens until they open it and decide. Check the address is right, and ask them to look in their spam folder.',
    granted: 'A parent or guardian has agreed. You are all set.',
    grantedBy: 'Agreed by',
    refused: 'They said no. Coach Diaz will not coach you without their agreement. If that was a mistake, you can send the link again below.',
    stale: 'We have changed what we ask guardians to agree to, so we need to ask again. Send the link below.',
  },
  intake: {
  ...
  tracker: {
    heading: 'Connect your workout tracker',
    intro:
      'If you already log your training in Hevy, connect it and the coach reads those workouts. Nothing to enter twice — your program, your charts and the next weight it suggests all come from the sessions you were already logging.',
    keyLabel: 'Hevy API key',
    whereToFind: 'In the Hevy app: Settings, then Developer, then generate an API key. Paste the whole thing.',
    proRequired: 'Hevy requires a Pro subscription to generate an API key. That is their rule, not ours.',
    connectButton: 'Connect Hevy',
    stateReady: 'Connected. Your recent workouts are in.',
    stateImporting: 'Connected. Still importing your last 90 days — press sync again to continue.',
    lastSynced: 'Last synced {when}.',
    syncButton: 'Sync now',
    syncing: 'Syncing…',
    runSummary: 'Brought in {imported} new workouts, skipped {duplicates} already here, removed {deleted}.',
    runMore: 'There is more to fetch — press sync again.',
    disconnectButton: 'Disconnect',
    disconnectNote: 'Disconnecting deletes your key from our database. The workouts already imported stay in your history.',
    readOnly: 'We only read. Nothing is ever written back to your Hevy account, and no routine of yours is changed.',
    failure: {
      tracker_key_rejected: 'Hevy would not accept that key any more. Generate a new one in their app and connect again.',
      tracker_rate_limited: 'Hevy asked us to slow down. Try again in a few minutes.',
      tracker_unavailable: 'Hevy did not answer last time. Try again shortly.',
      unknown: 'The last sync did not finish. Try again.',
    },
  },
  account: {
    title: 'Your data',
  ...
  progress: {
    ...
    hoverHint: 'Hover a point for the details, or use the arrow keys.',
    tapHint: 'Tap a point for the details.',
